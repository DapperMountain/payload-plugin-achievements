...
export function buildMetricBalancesCollection() {
    return {
        ...
        admin: collectionAdmin({
            ...
            description: 'Stored metric totals per user (and scope). Updated by recordMetricChange; repair with reconcile. Not for computed metrics.',
        }),
        fields: [
            userField(),
