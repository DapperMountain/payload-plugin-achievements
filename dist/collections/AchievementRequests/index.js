...
export function buildAchievementRequestsCollection() {
    return {
        ...
        admin: collectionAdmin({
            ...
            description: 'When someone asks to earn an achievement. We check eligibility, then either grant it right away or wait for a review.',
        }),
        fields: [
